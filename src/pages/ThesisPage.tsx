      ...
      <section style={{ background: BG_WARM, paddingTop: 72, paddingBottom: 96, paddingLeft: 24, paddingRight: 24 }}>
        <article style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <ol style={{ fontFamily: "'Outfit', sans-serif", fontSize: 15, lineHeight: 1.85, color: MUTED, paddingLeft: 20 }}>
            ...
            <li style={{ marginBottom: 14 }}>Tilley, N., Thompson, R., Farrell, G., Grove, L. and Tseloni, A. (2015). Do burglar alarms increase burglary risk? A counter-intuitive finding and possible explanation. <em>Crime Prevention and Community Safety, 17</em>(1), 1-19.</li>
            <li style={{ marginBottom: 14 }}>Welsh, B. C. and Farrington, D. P. (2009). Public area CCTV and crime prevention: An updated systematic review and meta-analysis. <em>Justice Quarterly, 26</em>(4), 716-745.</li>
          </ol>
