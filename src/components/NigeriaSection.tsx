...
export default function NigeriaSection() {
  return (
    <section style={{
      background: 'var(--bg)',
      padding: 'clamp(72px, 9vw, 112px) clamp(28px, 8vw, 100px)',
      ...
      <div className="origin-grid" style={{
        ...
        <FadeIn delay={0.12}>
          <div className="origin-artefact" style={{
            ...
            borderRadius: 12, padding: 18, boxShadow: '0 2px 16px rgba(0,0,0,0.04)', maxWidth: 280,
          }}>
            ...
            <p style={{
              ...
              color: 'var(--text-muted)', letterSpacing: '0.04em', marginTop: 12, textAlign: 'center',
            }}>
